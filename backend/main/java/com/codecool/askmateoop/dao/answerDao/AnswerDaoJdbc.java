...
public class AnswerDaoJdbc implements AnswerDAO {
    ...
    public List<Answer> getAllAnswers() {
        ...
        String sql = "SELECT id,description, answers.question_id, answers.user_id, created_at FROM answers;";
    ...
    public Answer getAnswerById(int id) {
        String sql = "SELECT id, description, question_id, user_id, created_at FROM answers WHERE id = ?;";
    ...
    public List<Answer> getAnswersByQuestionId(int questionId) {
        List<Answer> answers = new ArrayList<>();
        String sql = "SELECT id,description, answers.question_id, answers.user_id, created_at FROM answers WHERE question_id = ?;";
        try (Connection connection = databaseConnection.getConnection();
             Statement statement = connection.createStatement();
             ResultSet resultSet = statement.executeQuery(sql);) {
            while (resultSet.next()) {
